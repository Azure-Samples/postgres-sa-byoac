...
2. To import the AI chat component, insert the following `import` statement directly below the `import React from 'react';` line at the top of the file.
    ...
    ```javascript linenums="2"
    import CopilotChat from '../../components/CopilotChat';
    ```

3. Insert the following code below the closing tag of `<div>` containing the _Dashboard_ header (on line 10). This will insert the component within the `const Dashboard =() => {}` functional component block of the dashboard page.
