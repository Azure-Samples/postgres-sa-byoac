...
1. Return to the open instance of **VS Code**, select the PostgreSQL extension icon in the _Activity Bar_, and ensure it is connected to your PostgreSQL database.
