...
1. Return to the open instance of **VS Code** (or open it if you closed it after the setup tasks), select the PostgreSQL extension icon (elephant) from the _Activity Bar_, and ensure it is connected to your PostgreSQL database.
